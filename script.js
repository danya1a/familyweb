...
var activeConfig = config[currentMode];

var opts = {
        strings: activeConfig.strings,
        charSize: activeConfig.charSize,
        charSpacing: activeConfig.charSpacing,
        lineHeight: 40,
    ...
    calc = {
        totalWidth: opts.charSpacing * Math.max( opts.strings[0].length, opts.strings.length > 1 ? opts.strings[1].length : 0 )
    },
...
window.addEventListener( 'resize', function(){
    ...
    else if (newW < 1200) newMode = 'tablet';
